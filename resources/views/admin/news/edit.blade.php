...
@section('content')
            ...
            <div class="well">
                <div class="row" style="display:flex; justify-content: center; align-items: center;">
                    <div class="col-sm-10">
                        ...
                        <h4>Veillez à remplir chaque section avant de cliquer sur <b>Enregistrer</b>.</h4>
                    </div>
                    <div class="col-sm-2">
    ...
    <form id="editForm" method="post" role="form">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control input-lg" name="title" id="title" placeholder="Titre de l'article" value="{{ $post->title }}" required />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <textarea class="form-control wysihtml5" rows="18" data-stylesheet-url="/assets/css/wysihtml5-color.css" name="content" id="content" value="{{ $post->content }}" required></textarea>
            </div>
        </div>
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control datepicker" name="created_at" value="{{ date('d/m/Y', strtotime($post->created_at)) }}" data-format="D, dd MM yyyy">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="max-width: 310px; height: 160px;" data-trigger="fileinput">
                                <img src="/{{ str_replace('public', 'storage', $post->image) }}" alt="...">
                            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="text" value="{{ $post->tags }}" class="form-control tagsinput" id="tags" name="tags" />
...
@section('script')
    ...
    <script>
        $('.wysihtml5')[0].value = "{!! $post->content !!}";

        $('button#save').click(() => {
            const data = new FormData($('#editForm')[0]);

            $.ajax({
                url: "{{ route('news.update', ['news' => $post->id]) }}",
                type: "POST",
                data: data,
                cache: false,
                contentType: false,
