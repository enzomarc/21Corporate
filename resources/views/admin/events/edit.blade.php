        ...
        <div class="col-sm-12">
            <div class="well">
                <div class="row" style="display:flex; justify-content: center; align-items: center;">
                    <div class="col-sm-10">
                        <h3>Modification d'un evènement</h3>
                        <h4>Remplissez les informations concernant l'evènement puis cliquez sur <b>Modifier</b>.</h4>
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="panel-body">
                ...
                <form role="form" id="event-form" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="start_date" value="{{ $event->start_date }}" id="start_date">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="end_date" value="{{ $event->end_date }}" id="end_date">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="form-control autogrow" id="description" name="description" placeholder="Décrivez l'evènement de manière explicite (Ex: Lieu, Programme, Invités...)" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 98px;">{{$event->description}}</textarea>
                        </div>
                    </div>
...
@section('script')
    <script>
        $('#submit').click(() => {
            ...
            $.ajax({
                url: "{{ route('events.update', ['event' => $event]) }}",
                method: "POST",
                data: data,
                contentType: false,
                processData: false,
                success: (response) => {
                    toastr.success(response.message, 'Evènement modifié');
