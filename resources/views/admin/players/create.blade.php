            ...
            <div class="well">
                <div class="row" style="display:flex; justify-content: center; align-items: center;">
                    <div class="col-sm-10">
                        ...
                        <h4>Remplissez les informations personnelles, ainsi que les informations concernant la carrière et les accomplissements du joueur puis cliquez sur <b>Ajouter</b>.</h4>
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="panel-body">
                ...
                <form role="form" id="player-form" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="number" class="form-control" name="height" id="height" min="1" placeholder="En centimètres" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="number" class="form-control" name="weight" id="weight" min="1" placeholder="En kilogrammes" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="current_club" id="current_club">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="club_league" id="club_league">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="league_level" id="league_level">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="contract_expiration" id="contract_expiration">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="registration_type" id="registration_type">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="form-control autogrow" id="profile" name="profile" placeholder="Décrivez le joueur en quelques lignes" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 98px;"></textarea>
                        </div>
                    </div>
    ...
    <script>
        ...
        function refreshCareersTable() {
            ...
            _.each(careers, (career) => {
                table.innerHTML += "<tr><td>"+ career.start  +" - "+ career.end +"</td><td>"+ career.club +"</td><td>"+ career.country +"</td><td>"+ career.current_club +"</td><td>"+ career.matches +"</td><td>"+ career.goals +"</td><td><button onclick='deleteCareer("+ career.id +")' class='btn btn-danger'>Supprimer</button></td></tr>";
            });
        }
